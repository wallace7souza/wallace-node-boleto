...
let pathWhiteCode = pathResolve('./assets/w.png')

const blackCodeImg = fs.readFileSync(pathBlackCode, {encoding: 'base64'});
const whiteCodeImg = fs.readFileSync(pathWhiteCode, {encoding: 'base64'});
*/
...
Boleto.prototype.renderHTML = function (callback) {
  ...
  // renderOptions['boleto']['blackImg'] = blackCodeImg
  // renderOptions['boleto']['whiteImg'] = whiteCodeImg
